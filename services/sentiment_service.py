...
class SentimentService:
    ...
    async def analyze_market(self):
        ...
        try:
            ...
            ticker_btc = self.agent.controller.bot.client._request("/v5/market/tickers?category=linear&symbol=BTCUSDT")
            ticker_eth = self.agent.controller.bot.client._request("/v5/market/tickers?category=linear&symbol=ETHUSDT")
