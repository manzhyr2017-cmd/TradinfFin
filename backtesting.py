...
class Backtester:
    ...
    async def fetch_historical_data(
        ...
        try:
            ...
            endpoint = f"/v5/market/kline?category=linear&symbol={symbol}&interval={interval}&limit={limit}"
            result = await loop.run_in_executor(None, lambda: self.client._request(endpoint))
